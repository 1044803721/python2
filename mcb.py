...
def mcb(features1, features2, d:int=4, save=False, filename="mcb_feature.pickle"):
    """
...
a=np.array([[1,3,5,7],[5,4,6,8],[2,3,6,9],[9,4,2,8]])
b=np.array([[2,4,6,8],[1,4,3,4],[8,4,6,2],[9,4,1,1]])
c=np.array([[3,4,4,8],[1,4,7,4],[8,4,6,2],[8,4,2,1]])
print(a.shape)
d=mcb(a,b)
f=mcb(a,c)
g=mcb(b,c)
